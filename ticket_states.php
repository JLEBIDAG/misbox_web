...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Ticket States</h3>
                                    ...
                                    <div class="table-responsive">
                                        <table id="basic-datatables"
                                            ...
                                            <tbody>
                                                ...
                                                WHERE a.handle_by = ? AND a.status IN ('On Hold', 'In Progress' )
                                                ";
                                                ...
                                                if ($result->num_rows > 0):
                                                    while ($row = $result->fetch_assoc()):
                                                        ...
                                                        <tr data-id="<?= $row["PK_activityLogID"] ?>"
                                                            data-ticketNo="<?= $row["ticket_no"] ?>" class="viewBtn"
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" class="btn btn-success btn-xs message-btn"
                                                                    style="margin:5px;" data-bs-toggle="modal"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea class="form-control" name="ViewMessages" id="ViewMessages"
    ...
    <div class="modal fade" id="viewTicketModal" tabindex="-1" aria-labelledby="viewTicketLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-header ModalHeaderDesign">
                    <h4 class="modal-title">
                        <b style="color:white">VIEW MESSAGE</b>
                    </h4>
                    <button type="button" class="close" id="closeBtn" data-bs-dismiss="modal"
                        style="color:white">&times;</button>
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form id="ViewMessageForm">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">

                                    <input type="hidden" class="form-control" id="ViewTicketNo" name="ViewTicketNo"
                                        readonly>
                                    <input type="hidden" class="form-control" id="FKactivityLogID"
                                        name="FKactivityLogID" readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea class="form-control" name="ViewOldMessages" id="ViewOldMessages" rows="10"
                                        readonly></textarea>
                                    <label class="floating-label">Message</label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea class="form-control" name="ViewMessages" id="ViewMessages"
                                        rows="7"></textarea>
                                    <label class="floating-label">New Message</label>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-info" id="closeBtn"
    ...
    $status_counts = ["In Progress" => 0, "On Hold" => 0];
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            document.getElementById("ViewMessageForm").addEventListener("submit", function (event) {
                event.preventDefault(); // Prevent default form submission

                let formData = new FormData(this);
                $.ajax({
                    url: "update_ticket_state_message.php", // Ensure the correct file name
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
                    ...
                    success: function (response) {
                        ...
                        if (response.success) {
                            ...
                            setTimeout(function () {
                                window.location.href = 'ticket_states.php';
                            }, 2000);
                        } else {
