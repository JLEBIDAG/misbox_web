                ...
                send: function(e, t) {
                    ...
                    o = function(e) {
                        return function() {
                            ...
                            "abort" === e ? r.abort() : "error" === e ? "number" != typeof r.status ? t(0, "error") : t(r.status, r.statusText) : t(Yt[r.status] || r.status, r.statusText, "text" !== (r.responseType || "text") || "string" != typeof r.responseText ? { // error 
                                binary: r.response
                            } : {
                                text: r.responseText
