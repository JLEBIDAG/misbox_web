...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Tickets</h3>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="usernameCheck">
                                                        <label class="form-check-label"
                                                            for="usernameCheck">Username</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                                                    ...
                                                    if ($_SESSION['PK_userID'] == $_SESSION['PK_userID']) {
                                                        if ($result->num_rows > 0) {
                                                            echo '<select name="UpdateAccomBy" id="usernameSelect" class="form-control form-control-sm" disabled>';
    ...
    <script>
        ...
        document.getElementById("usernameCheck").addEventListener("change", function () {
            document.getElementById("usernameSelect").disabled = !this.checked;
        });
    ...
    <script>
        $(document).ready(function () {
            $("#filterBtn").click(function () {
                ...
                let usernameSelectval = $("#usernameSelect").val();
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        usernameSelect: usernameSelectval,
